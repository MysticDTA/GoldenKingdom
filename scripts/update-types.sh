#!/bin/bash
# 🔄 Helper script to regenerate Supabase types locally
...
echo "✅ Types updated at $OUTPUT_FILE"

# Optionally commit immediately
git add $OUTPUT_FILE
git commit -m "chore: update Supabase types" || echo "No changes to commit"
echo "🚀 Types committed. Run 'git push origin main' to sync."
